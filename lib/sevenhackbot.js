...
var SevenHackBot = function Constructor(settings) {
    ...
    this.dbPath = settings.dbPath || path.resolve(process.cwd(), 'data', '7hackbot.db');
...
SevenHackBot.prototype._connectDb = function () {
...
SevenHackBot.prototype._firstRunCheck = function () {
    var self = this;
...
SevenHackBot.prototype._welcomeMessage = function () {
...
SevenHackBot.prototype._replyWithRandomJoke = function (originalMessage) {
    var self = this;
